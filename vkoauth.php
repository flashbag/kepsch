...
$request = 'https://oauth.vk.com/access_token?client_id=3685024&redirect_uri=http://'.$_SERVER['SERVER_NAME'].'/vkoauth.php&code='.$_GET['code'].'&client_secret=WETngl0p14cJ9IuHbCQY';
...
if ($response['access_token']) {
	...
	$User = array(
			'check' 		=> md5(md5(substr($user['uid'], 0, 2))),
			'vkid' 			=> $user['uid'],
			'sex' 			=> $user['sex'],
...
<form action="./identify" id="user" method="post" style="display: none;">
