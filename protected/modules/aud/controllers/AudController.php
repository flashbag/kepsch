...
class AudController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Aud']))
		{
			$model->attributes=$_POST['Aud'];
			if($model->save()) {
				Yii::app()->user->setFlash('info', '<span class="single-name">аудиторію</span> <b>'.$model->name.'</b> '.Yii::app()->params['postActions'][Yii::app()->controller->action->id].'!');
				$this->redirect(array('/aud'));
			}
		}
	 ...
	 * @param Aud $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='aud-form')
		{
