...
/**
 * This is the model class for table "sch_aud".
 *
 * The followings are the available columns in table 'sch_aud':
 * @property integer $id
 ...
 */
class Aud extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Aud the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('name', 'required'),
			array('type, created_by, created_time, updated_by, updated_time, status', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>45),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, type, name, created_by, created_time, updated_by, updated_time, status', 'safe', 'on'=>'search'),
